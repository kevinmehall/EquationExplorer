...
function draw_vector_field(gp, fn, r, g, b){
	...
	var step = (gp.tmax-gp.tmin)/10000;

	ctx.beginPath()
	for (var t=gp.tmin; t<=gp.tmax; t+=step){
		var pt = fn(t)
...
$(function(){
	...
	bindInputToAttr($('#tmin'), gp, 'tmin', redrawAll)
	bindInputToAttr($('#tmax'), gp, 'tmax', redrawAll)
